...
<li> Packages Used - Packages I worked with were data.table, tseries, fPortfolio, PortfolioAnalytics, PerformanceAnalytics, xts etc. </li>
<li> Application - In addition to learning the language and its syntax, I explored different uses in applying it for portfolio optimization and analyzing stocks. </li>
<li> Types of code - </li>
<br>
